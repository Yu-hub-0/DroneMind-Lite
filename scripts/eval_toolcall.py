...
def init_model(args):
    ...
    if 'model' in args.load_from:
        model = DroneMindForCausalLM(DroneMindConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers, use_moe=bool(args.use_moe)))
...
def main():
    parser = argparse.ArgumentParser(description="DroneMind ToolCall评测")
    ...
    parser.add_argument('--api_model', default='dronemind-3:latest', type=str, help="API请求时使用的模型名称")
